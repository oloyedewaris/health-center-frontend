          ...
          <Box padding='24px' w='full'>
            <form onSubmit={formik.handleSubmit}>
              ...
              <Button width="full" mt={6} type="submit">
                {registerBioDataMutation.isLoading ? (
          ...
          <ModalBody maxH='90vh' overflowY={'scroll'}>
            <Box my='10%'>
              ...
              <Flex justify={'space-between'} align='center' mt='30px'>
                <Button
                  disabled={registerBioDataMutation}
                  isLoading={registerBioDataMutation}
                  w='45%' onClick={handleProceedAsDependant}
                >Yes</Button>
